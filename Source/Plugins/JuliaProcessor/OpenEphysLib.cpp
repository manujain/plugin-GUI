...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Julia Processor"; //Name of the Library, used only for information
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->processor.name = "Julia Processor"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<JuliaProcessor>); //Class factory pointer. Replace "JuliaProcessor" with the name of your class.
		break;
/**
